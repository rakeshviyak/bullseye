...
function ConvertCoordinate(inputXYList, inputSR, outputSR, callback) {
    ...
    "esri/tasks/GeometryService", "dojo/domReady!"],
        function (_SpatialReference, _Point, _Graphic, _SimpleMarkerSymbol, _GeometryService, Ready) {
...
function getLineGraphic(linePath, inputSR) {
    ...
    for (var l = 0; l < splitLine.length; l = l + 2) {
        point1 = new _Point(splitLine[l], splitLine[l + 1], new _SpatialReference({ wkid: inputSR }))
        LineArr.push(point1)
    }
    var polyline = new _Polyline(new _SpatialReference({ wkid: inputSR }))
    polyline.addPath(LineArr)
    var lngraphic = new _Graphic();
...
var _OneMapGlobalToken = '';
document.write('<link rel="stylesheet" type="text/css" href="http://t1.onemap.sg/arcgis_js_api/library/3.10/arcgis/js/dojo/dijit/themes/tundra/tundra.css"/>');document.write('<link rel="stylesheet" type="text/css" href="http://t1.onemap.sg/arcgis_js_api/library/3.10/arcgis/js/esri/css/esri.css"/>');document.write('<script type="text/javascript" src="http://t1.onemap.sg/arcgis_js_api/library/3.10/arcgis/init.js"></script>');var _OneMapGlobalToken='qo/s2TnSUmfLz+32CvLC4RMVkzEFYjxqyti1KhByvEacEdMWBpCuSSQ+IFRT84QjGPBCuz/cBom8PfSm3GjEsGc8PkdEEOEr';var projSys='';s